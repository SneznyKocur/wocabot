...
def vsetky_baliky():
    ...
    while woca.get_packages(woca.DOPACKAGE):
        ...
        try:
            ...
            print(f"urobene {urobene} balikov za {urobene*(0.75/3)}€")
            exit(0)
    print(f"urobene {urobene} balikov za {urobene*(0.75/3)}€")
...
parser.add_argument(
    "--do-package", action="store_true", dest="do_package", required=False
)
parser.add_argument("--learn-all", action="store_true", dest="learnall", required=False)
parser.add_argument(
    "--get-classes", "--classes", action="store_true", dest="getclasses", required=False
)
parser.add_argument(
    "--get-packages",
    "--packages",
...
parser.add_argument(
    "--get-leaderboard", "--leaderboard", action="store_true", dest="leaderboard"
)
parser.add_argument("--auto", action="store_true", dest="auto", required=False)
parser.add_argument(
    "--leaderboard-pos", "--pos", action="store_true", dest="pos", required=False
)
